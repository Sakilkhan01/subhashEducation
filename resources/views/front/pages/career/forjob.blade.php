...
<section id="content">
    <div class="content_wrapper">
        <div class="container">
            <div class="col-sm-12 col-lg-12 col-md-12 contact-part">
                <br />
                <br />
                <p>One of the most trusted institute in K-12 education and JEE/NEET coaching at National Level, we are always looking for great people to work with us.</p>

                <p>
                    Staffed with young, passionate people, we're all working hard to make a difference in the lives of our students by ensuring best possible outcome for every student. Our core value is "everything we do must be in the best
                    interest of our students." We don't have a fixed hiring cycle/window and always on look out for faculties, marketing &amp; sales professionals, operational managers, counselors etc.
                </p>

                <p>
                    For teaching positions - we prefer to look for faculty members from premier institutes such as IITs, NITs, BITS etc. but are open to hire outstanding candidates who have completed their education from outside of these
                    institutes.
                </p>

                <p>
                    For management positions, we prefer candidates with MBAs from recognized universities. However, we encourage you to apply without an MBA if you sizeable experience (at least 2 years) at the nationally recognized brands.
                </p>
            </div>
                    ...
                    <form action="" method="post" accept-charset="utf-8" autocomplete="off" id="dialog_form" enctype="multipart/form-data" class="my-form row">
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-6 col-xs-6" style="z-index: 1;">
                            ...
                            <select class="form-control" name="division" title="Matrix division" id="division">
                                ...
                                <option value="Non academic team">Non-Academic Teams</option>

                                <option value="Digital marketing team">Digital Marketing Team</option>
                                <option value="offline media marketing team">Offline / Media Marketing Team </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6" style="z-index: 1;">
                            <label>Current salary (In rupees per month)<span>*</span><span class="smallFont"> (Please mention the actual. If need arises, this will be verified through pay slips and bank account statements.)</span></label>
                        ...
                        <div id="inputtype" class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6" style="z-index: 1;">
                            <label>Your Mobile No <span>*</span> <span class="smallFont"> We will send you OTP on this number so please enter correct number.</span></label>
                        ...
                        <div id="inputtype" class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3" style="z-index: 1;">
                            ...
                            <img src="https://www.matrixedu.in/assets/captcha/1670843933.098.jpg" style="width: 100px; height: 35px; border: 0;" alt=" " />
                        </div>
                        <div id="inputtype" class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3" style="z-index: 1;">
